...
class CifarDataProvider(DataProvider):
    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=500, valid_size=None,
                 n_worker=8, local_rank=0, world_size=1, **kwargs):

        self._save_path = save_path
        self.valid = None
        self.train = get_cifar_iter('train', self.save_path, train_batch_size, n_worker, cutout=16)
        self.test = get_cifar_iter('val', self.save_path, test_batch_size, n_worker, cutout=16)
